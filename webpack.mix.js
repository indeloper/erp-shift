...
mix.copy('resources/assets/js/common/devextreme/dx.all.js', 'public/js/devextreme/dx.all.js');
mix.copy('resources/assets/js/common/devextreme/dx.all 23.1.7.js', 'public/js/devextreme/dx.all 23.1.7.js');
mix.copy('resources/assets/js/common/devextreme/dx.messages.ru.js', 'public/js/devextreme/dx.messages.ru.js');
