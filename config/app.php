...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If this parameter set to true in .env, you will see all dumps
    | from new notifications logic!
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Notification New System Work Dumping
    |--------------------------------------------------------------------------
    |
    | If you need to listen to notifications dumps, add a new variable to your .env file
    |
    */
