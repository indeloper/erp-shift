...
class MaterialObjectsRemainsXLSXReport implements FromCollection, ShouldAutoSize, WithColumnWidths, WithEvents, WithHeadings, WithTitle
{
    use Exportable;
