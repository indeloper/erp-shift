...
class BasesReportExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithTitle, WithDrawings, WithColumnFormatting
{
    use Exportable;
    ...
    {
        $this->count_convert = collect($data->result)->max(function($item) {return count((array)$item->convert_params);});
