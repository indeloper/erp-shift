...
class BrigadeCreateRequest extends FormRequest
{
    /**
    ...
    {
        return boolval(auth()->user()->hasPermission('human_resources_brigade_create'));
    }
    ...
    public function withValidator($validator)
    {
        if ($this->foreman_id) {
            ...
            $brigade = Brigade::where('foreman_id', $this->foreman_id)->first();
    ...
    {
        return [
            'number' => ['required', 'integer', 'unique:brigades,number'],
