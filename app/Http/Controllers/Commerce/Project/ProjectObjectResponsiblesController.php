...
use App\Services\ProjectObjectResponsibleService;

final class ProjectObjectResponsiblesController
{

    public function __construct(
        protected ProjectObjectResponsibleService $projectObjectContactService
    ) {}

    public function index(ProjectObject $projectObject)
    {
        return ProjectObjectContactResource::collection(
            ProjectObjectResponsible::query()
