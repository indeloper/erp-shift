...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        TimesheetDayCategory::insert([
            ...
            [
                'name' => 'Отпуск без сохранения заработной платы', 'shortname' => 'З', 'created_at' => now(),
                'updated_at' => now()
            ],
            ['name' => 'Прогул', 'shortname' => 'П', 'created_at' => now(), 'updated_at' => now()],
            [
                'name' => 'Отсутствие по невыясненной причине', 'shortname' => 'Н', 'created_at' => now(),
                'updated_at' => now()
            ],
            [
                'name' => 'Отпуск по беременности и родам', 'shortname' => 'БиР', 'created_at' => now(),
                'updated_at' => now()
            ],
        ...
        TimesheetTariff::insert([
            [
                'name' => 'Обычный час', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => false, 'tariff_color' => '',
                'sort_order' => 10, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Переработки', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => true, 'tariff_color' => '',
                'sort_order' => 20, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Монтаж крепления', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => false,
                'tariff_color' => '', 'sort_order' => 30, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Монтаж крепления (Переработка)', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => true,
                'tariff_color' => '', 'sort_order' => 40, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Демонтаж крепления', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => false,
                'tariff_color' => '', 'sort_order' => 50, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Демонтаж крепления (Переработка)', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => true,
                'tariff_color' => '', 'sort_order' => 60, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Обычный час с г/м', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => false,
                'tariff_color' => '', 'sort_order' => 70, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Переработки с г/м', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => true,
                'tariff_color' => '', 'sort_order' => 80, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Zoomlion', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => false, 'tariff_color' => '',
                'sort_order' => 90, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Zoomlion (переработка)', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => true,
                'tariff_color' => '', 'sort_order' => 100, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Вспомогательные работы', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => false,
                'tariff_color' => '', 'sort_order' => 110, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Простой (дома)', 'timesheet_tariffs_type_id' => 1, 'is_overwork' => true,
                'tariff_color' => '', 'sort_order' => 120, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Опоздание', 'timesheet_tariffs_type_id' => 3, 'is_overwork' => false, 'tariff_color' => '',
                'sort_order' => 130, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Погружение вибро', 'timesheet_tariffs_type_id' => 2, 'is_overwork' => false,
                'tariff_color' => '#FF6666', 'sort_order' => 140, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Погружение вдвоем вибро', 'timesheet_tariffs_type_id' => 2, 'is_overwork' => false,
                'tariff_color' => '#FFA0A0', 'sort_order' => 150, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Извлечение вибро', 'timesheet_tariffs_type_id' => 2, 'is_overwork' => false,
                'tariff_color' => '#E6B9B8', 'sort_order' => 160, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Погружение статика', 'timesheet_tariffs_type_id' => 2, 'is_overwork' => false,
                'tariff_color' => '#0070C0', 'sort_order' => 170, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Извлечение статика', 'timesheet_tariffs_type_id' => 2, 'is_overwork' => false,
                'tariff_color' => '#8DB4E3', 'sort_order' => 180, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Обычный час', 'timesheet_tariffs_type_id' => 4, 'is_overwork' => false, 'tariff_color' => '',
                'sort_order' => 190, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'name' => 'Переработки', 'timesheet_tariffs_type_id' => 4, 'is_overwork' => true, 'tariff_color' => '',
                'sort_order' => 200, 'created_at' => now(), 'updated_at' => now()
            ],
        ]);
        ...
        if (!Schema::hasTable('timesheet_aggregated_salary_summary')) {
            Schema::create('timesheet_aggregated_salary_summary', function (Blueprint $table) {
                ...
                $table->foreign('project_object_id')->references('id')->on('project_objects');
                $table->foreign('post_id')->references('id')->on('groups');
                $table->foreign('timesheet_tariffs_type_id',
                    'summary_timesheet_tariffs_type_id_foreign')->references('id')->on('timesheet_tariffs_types');
                $table->foreign('timesheet_post_tariff_id',
                    'summary_timesheet_post_tariff_id_foreign')->references('id')->on('timesheet_post_tariffs');
            });
        }
        ...
        if (!Schema::hasTable('timesheet_employees_summary_hours')) {
            Schema::create('timesheet_employees_summary_hours', function (Blueprint $table) {
                ...
                $table->foreign('timesheet_day_category_id',
                    'summary_hours_timesheet_date_category_id_foreign')->references('id')->on('timesheet_day_categories');
                $table->foreign('timesheet_card_id')->references('id')->on('timesheet_cards');
            });
        }
