...
class CreateQ3wMaterialOperationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        /*$routeStageNames = [['Инициализация', null, 1, 1], ['Уведомление руководителю проектов', 1, 1, 4], ['Завершена', 2, 1, 2],
            ...
            ['Уведомление руководителю отправителя', 7, 2, 4], ['Уведомление руководителю получателя', 8, 2, 4],
            ['Конфликт у отправителя', 13, 2, 6], ['Конфликт у получателя', 14, 2, 6],
            ['Уведомление отправителю', 15, 2, 4], ['Уведомление получателю', 16, 2, 4],
            ['Завершена', 17, 2, 2], ['Завершена', 18, 2, 2]];*/
