...
class AddPayAndHoldSeePermission extends Migration
{
    const PERMISSION_CODENAME = 'human_resources_pay_and_hold_see';

    const PERMISSION_NAME = 'Просмотр всех выплат и удержаний';
