...
class AddObjectBrigadeAssignmentPermission extends Migration
{
    const PERMISSION_CODENAME = 'human_resources_project_brigade_assignment';

    const PERMISSION_NAME = 'Назначение бригады на объект';
