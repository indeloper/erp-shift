...
class AddJobCategoryStorePermission extends Migration
{
    const PERMISSION_CODENAME = 'human_resources_job_category_create';

    const PERMISSION_NAME = 'Создание должностной категории';
