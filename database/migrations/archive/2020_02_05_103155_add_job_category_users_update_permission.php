...
class AddJobCategoryUsersUpdatePermission extends Migration
{
    const PERMISSION_CODENAME = 'human_resources_job_category_users_update';

    const PERMISSION_NAME = 'Изменение состава должностной категории';
