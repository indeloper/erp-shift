...
class AddJobCategoryUpdatePermission extends Migration
{
    const PERMISSION_CODENAME = 'human_resources_job_categories_update';

    const PERMISSION_NAME = 'Изменение должностной категории';
