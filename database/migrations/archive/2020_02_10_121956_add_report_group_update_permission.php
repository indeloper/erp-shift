...
class AddReportGroupUpdatePermission extends Migration
{
    const PERMISSION_CODENAME = 'human_resources_report_group_update';

    const PERMISSION_NAME = 'Изменение отчётных групп';
