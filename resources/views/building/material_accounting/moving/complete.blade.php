            ...
            <div class="card-body">
                <div class="row" id="sender_answer">
                    <div class="col-md-12 iphone-quote-container">
                        <label style="margin:10px">Комментарий отправителя</label>
                        <blockquote>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <el-button type="text" @click="dialogTableVisible = true" class="docs-btn">
                ...
                <div class="row" id="recipient_answer">
                    <div class="col-md-12 iphone-quote-container">
                        <label style="margin:10px">Комментарий получателя</label>
                        <blockquote>
                            <p style="font-size:14px">
                ...
                <div class="row" id="author_answer">
                    <div class="col-md-12 iphone-quote-container">
                        ...
                        <blockquote>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <a href="#" data-toggle="modal" data-target="#view-photo-author" class="table-link blockquote-link">
                                        <i class="fa fa-picture-o "></i>
                                        Фото
                                    </a>
                                    <el-button type="text" @click="dialogTableVisible = true" class="docs-btn">
...
<div class="modal fade bd-example-modal-lg show" id="view-photo-author" role="dialog" aria-labelledby="modal-search" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Фото</h5>
...
var sender_answer = new Vue({
    el: '#sender_answer',
    data: {
        docsList: {!! json_encode(array_values($operation->documents_sender->toArray())) !!},
...
var author_answer = new Vue({
    el: '#author_answer',
    data: {
        docsList: {!! json_encode(array_values($operation->documents_author->toArray())) !!},
        dialogTableVisible: false,
    },
    methods: {
        url_to_doc: function (index, row) {
