            ...
            <div class="card-body" id="base" v-cloak>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <template>
                            <el-select v-model="selected" @change="clean_materials" clearable filterable :remote-method="search"  @if($edit_restrict) disabled @endif remote name="object_id" placeholder="Поиск">
                                <el-option
...
@section('js_footer')
    ...
    <script type="text/javascript">
      ...
      <div class="row">\
        <div class="col-10 mb-10">\
              ...
              <template>\
                <el-select @change="changeMaterialId" ref="usernameInput" v-model="default_material_id" @clear="search(``)" clearable filterable @if($edit_restrict) disabled @endif :remote-method="search" remote size="large" placeholder="Выберите материал">\
                  <el-option\
          ...
          ',
            props: ['material_id', 'material_unit', 'material_count', 'used', 'inputs_length', 'material_index', 'used', 'materials', 'units', 'index', 'used'],
            computed: {
        ...
        var materials_from = new Vue({
            ...
            data: {
                ...
                exist_materials: {!! $operation->materials->where('type', 7) !!}
            },
            mounted: function () {
                const that = this;
      ...
      <div class="row">\
        <div class="col-md-12 mb-10">\
              ...
              <template>\
                <el-select @change="changeMaterialId" ref="usernameInput" @if($edit_restrict) disabled @endif v-model="default_material_id" clearable filterable :remote-method="search" @clear="search(``)" remote size="large" placeholder="Выберите материал">\
                  <el-option\
    ...
    ',
            props: ['material_id', 'material_unit', 'material_count', 'inputs_length', 'material_index', 'used', 'materials', 'units', 'index'],
            methods: {
                changeMaterialId(value) {
        ...
        var materials_to = new Vue({
            ...
            data: {
                ...
                material_inputs: [],
                units: {!! json_encode($operation->materials()->getModel()::$main_units) !!},
                exist_materials: {!! $operation->materials->where('type', 6) !!},
                default_materials: [],
                new_materials: [],
            },
            mounted: function () {
