...
@section('content')
    ...
    <div class="row">
            ...
            @if($operation->isAuthor())
                <div class="card">
                    <div class="card-body">
                        ...
                        <ol>
                            <li>
                                Проверьте количество материала до и после преобразования в блоке <i>"Сведения о материалах"</i>.
                            </li>
                            <li>
      ...
      {{--            </div>\--}}
      {{--            ',--}}
      {{--              props: ['material_id', 'material_unit', 'material_count', 'inputs_length', 'material_index', 'used', 'materials', 'units', 'index', 'material_input'],--}}
      {{--              computed: {--}}
