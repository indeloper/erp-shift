...
<div class="row">
    <div class="col-md-12 col-xl-10 ml-auto mr-auto pd-0-min">
        ...
        @if($operation->comment_to || $operation->materialFiles->count() || $operation->comment_from)
        <div class="card strpied-tabled-with-hover">
            <div class="card-body">
                @if($operation->comment_from || $operation->materialFiles->count())
                                ...
                                <div class="col-md-7">
                                    ...
                                    <el-dialog title="Сопроводительные документы" :visible.sync="dialogTableVisible">
                                      <el-table :data="docsList">
                                        ...
                                        <el-table-column property="url" label="Действия" align="right">
                ...
                @endif
                @if($operation->comment_to || $operation->materialFiles->count())
                <div class="row" id="recipient_answer">
                    <div class="col-md-12">
                        <label style="margin:10px">Комментарий автора заявки</label>
                        <blockquote>
                            <p style="font-size:14px">
