...
<div class="row">
    <div class="col-md-12 col-xl-10 ml-auto mr-auto pd-0-min">
        ...
        @include('building.material_accounting.modules.history_from')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card border-0" >
                    <div class="card-body ">
                        @foreach($operation->all_images_author as $image)
...
<script>
    ...
    var recipient_answer = new Vue({
        el: '#recipient_answer',
        data: {
            docsList: {!! json_encode($operation->all_documents_author) !!},
            dialogTableVisible: false,
        },
        methods: {
            url_to_doc: function (index, row) {
