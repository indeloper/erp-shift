            ...
            @if($operation->isAuthor())
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="materials">
                            <div class="card-body">
                                <h6 style="margin-bottom:20px">Номенклатура</h6>
                                <div class="materials">
                                    <div
                                        is="material-item"
...
@section('js_footer')
    ...
    <script type="text/javascript">
        ...
        ',
            props: ['material_id', 'material_unit', 'material_count', 'inputs_length', 'material_index', 'used', 'materials', 'units', 'used'],
            computed: {
    ...
    var answer = new Vue({
        ...
        methods: {
            ...
            send() {
                swal({
                    title: 'Вы уверены?',
                    html: "Весь материал будет списан с объект.",
                    type: 'warning',
                    ...
                    if (result.value) {
                axios.post('{{ route('building::mat_acc::write_off::accept', $operation->id) }}', {materials: materials.material_inputs, comment: answer.comment}).then(function (response) {
