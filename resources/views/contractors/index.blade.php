        ...
        <div class="card strpied-tabled-with-hover">
            <div class="fixed-table-toolbar toolbar-for-btn">
                <div class="fixed-search">
                    <form action="{{ route('contractors::index') }}">
                        <input class="form-control" type="text" value="{{ Request::get('search') }}" name="search" placeholder="Поиск">
                    </form>
                </div>
                @can('contractors_create')
                    <div class="pull-right">
                        <a href="#">
                            <a class="btn btn-round btn-outline btn-sm add-btn" href="{{ route('contractors::create') }}">
                ...
                <table class="table table-hover mobile-table">
                    ...
                    <tbody>
                        @foreach($contractors as $contractor)
                            <tr style="cursor:default" class="href" data-href="{{ route('contractors::card', [$contractor->id, 'contractor_id' => $contractor->id]) }}">
            ...
            @else
                <p class="text-center">В этом разделе пока нет ни одного контрагента</p>
            @endif
