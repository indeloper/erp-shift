            ...
            <div class="card-body">
                ...
                <div class="row" style="margin-top:50px">
                    <div class="col-md-12 text-right">
                        <a :href="'{{ route('building::tech_acc::technic_category.our_technic.trashed_index', 'category_id') }}'.split('category_id').join(category.id)" class="tech-link purple-link">Перейти в список техники</a><span class="purple-link"> → </span>
                    </div>
                </div>
            </div>
        </div>
