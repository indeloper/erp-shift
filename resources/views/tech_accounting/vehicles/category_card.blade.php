                ...
                <div class="row">
                    ...
                    @can('tech_acc_vehicle_category_edit')
                        <div class="col-md-4 text-right">
                            <a href="{{ route('building::vehicles::vehicle_categories.edit', $vehicle_category->id) }}" class="btn btn-round btn-sm btn-primary">Редактировать</a>
                        </div>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="row" style="margin-top:50px">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('building::vehicles::vehicle_categories.our_vehicles.index', $vehicle_category->id) }}" class="tech-link purple-link">Перейти в список транспорта</a><span class="purple-link"> → </span>
                    </div>
                </div>
            </div>
        </div>
