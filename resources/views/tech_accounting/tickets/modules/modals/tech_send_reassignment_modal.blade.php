<div class="modal fade bd-example-modal-lg show" id="tech-send-reassignment" role="dialog" aria-labelledby="modal-search" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content pb-3">
            <div class="modal-header">
                <h5 class="modal-title">Передача контроля отправки техники</h5>
            ...
            <div class="modal-body pt-0">
                <validation-observer ref="observer" :key="observer_key">
                    <div class="modal-section mt-3">
                        ...
                        <validation-provider rules="required" vid="send-select"
                                             ref="send-select" name="исполнитель" v-slot="v">
    ...
    <script>
        var techSendConfirm = new Vue({
            ...
            methods: {
                ...
                search_responsible_senders(query, without = '{{ auth()->id() }}') {
                    if (query) {
