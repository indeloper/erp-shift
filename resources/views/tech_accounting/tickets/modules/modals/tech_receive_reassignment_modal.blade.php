<div class="modal fade bd-example-modal-lg show" id="tech-receive-reassignment" role="dialog" aria-labelledby="modal-search" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content pb-3">
            <div class="modal-header">
                <h5 class="modal-title">Передача контроля получения техники</h5>
            ...
            <div class="modal-body pt-0">
                <validation-observer ref="observer" :key="observer_key">
                    <div class="modal-section mt-3">
                        ...
                        <validation-provider rules="required" vid="receive-select"
                                             ref="receive-select" name="исполнитель" v-slot="v">
    ...
    <script>
        var techReceiveConfirm = new Vue({
            ...
            methods: {
                ...
                search_responsible_receivers(query, without = '{{ auth() ->id()}}') {
                    if (query) {
