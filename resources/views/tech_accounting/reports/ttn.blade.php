            ...
            <div class="list-body" style="margin-top:-20px">
                ...
                <table class="ttn-table" style="border-bottom:0">
                    <tbody>
                        ...
                        <tr>
                            <th colspan="3">
                                <span class="dib title" style="width: 1px; white-space: nowrap;float:left;">3. Наименование груза</span>
                                <b style="font-size:6pt; float:center;">
                                {{ $cargo }}
                                </b>
                            </th>
                        </tr>
                        ...
                        <tr>
                            <th style="width:50%; text-align:left">
                                ...
                                <b>{{ $object_from->address ?? '' }}</b>
                            </th>
                            <th style="width:50%; text-align:left" colspan="2">
                                <span class="dib title" style="margin-right: 7px">
                                    7. Сдача груза
                                </span>
                                <b>{{ $object_to->address ?? '' }}</b>
                            </th>
                        </tr>
                        <tr>
                            <td style="width:50%;">
