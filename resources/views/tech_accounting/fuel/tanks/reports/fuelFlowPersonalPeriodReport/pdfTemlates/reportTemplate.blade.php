               ...
               @if (!isset($objectTransferGroups['income']) && !$isEmptyIncomeRegionRendered) 
                        ...
                        @foreach($objectTransferGroup as $fuelFlowOperation)
                                ...
                                <tr>
                                    ...
                                    <td class="td-normal"  style="text-align:right">{{number_format($fuelFlowOperation['volume'], 0, ',', ' ')}}</td>
                                </tr>
                    ...
                    <table style="width: 100%; margin-top: 20px;">
                        <tr>
                            ...
                            <td style="padding: 5px 0; text-align: right;">{{number_format($summaryData['fuelLevelPeriodStart'], 0, ',', ' ')}} л</td>
                            <td style="padding: 5px 0 5px 20px; ">Итого поступило топлива: </td>
                            <td style="padding: 5px 0; text-align: right">{{number_format($incomesTotalAmount ?? 0, 0, ',', ' ')}} л</td>
                        </tr>
                        <tr>
                            <td style="padding: 5px 0;">Остаток на конец периода:</td>
                            <td style="padding: 5px 0; text-align: right">{{number_format($summaryData['fuelLevelPeriodFinish'], 0, ',', ' ')}} л</td>
                            <td style="padding:  5px 0 5px 20px;">Итого израсходовано топлива: </td>
                            <td style="padding: 5px 0; text-align: right">{{number_format($outcomesTotalAmount ?? 0, 0, ',', ' ')}} л</td>
                        </tr>
                    </table>
