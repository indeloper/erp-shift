<script>
    ...
    const renderFileUploader = (wrapperElement) => {
        ...
        const fileUploaderAnchorDivWrapper = $('<div id="fileUploaderAnchorDivWrapper" >')
        fileUploaderAnchorDivWrapper.append('<div id="fileUploaderNewFileButtonAnchorDiv">')
        wrapperElement.append(fileUploaderAnchorDivWrapper)
