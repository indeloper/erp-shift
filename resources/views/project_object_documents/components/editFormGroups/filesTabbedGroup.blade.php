@include('project_object_documents.components.editFormGroups.fileUploadingVariablesAndFunctions')
                                                ...
                                                onUploaded(e) {
                                                    ...
                                                    fileReader.onload = function () {
                                                        ...
                                                        if(isFileImg || isFilePdf){
                                                            ...
                                                            newFileURL = 'img/fileIcons/XLS_icon.jpg'

                                                            if(e.file.name.includes('.doc') || e.file.name.includes('.docx'))
                                                            newFileURL = 'img/fileIcons/WORD_icon.jpg'
                                                        } 
                                                        ...
                                                        if(!uploadingFiles.length && i>0) {
                                                            ...
                                                            for (let index = 0; index < images.length; index++) {
                                                                ...
                                                                element.addEventListener('click',(e) =>{ createDynamycLightGalleryData(e)})
                                                            }
                                                            ...
                                                            $('.newFileDivCSS').hover(
                                                                function(){
                                                                    ...
                                                                    let deleteButton = $('<div />').dxButton({
                                                                        icon: "fas fa-trash",
                                                                        hint: "Удалить",
                                                                        elementAttr: { class: 'attacmentHoverDeleteButton attacmentNewHoverDeleteButton'},
                                                                        onClick(e) {
                                                                            console.log(e);
                                                ...
                                                $('<div>')
                                                    ...
                                                    if(projectObjectDocumentInfoByID.items()[0]) {
                                                        ...
                                                        Object.keys(filesDataArr).forEach(group=>{
                                                            ...
                                                            // addLightGallery('filesGroupWrapper' + i)
                                                            
                                                            // Перенес в EditForm onContentReady
                                                            // Пробовал выносить повтор кода по LightGallery для PDF во внешнюю функцию - не работает
                                                            // let fakeCoverPdfElems =  document.getElementById('filesNotImgGroupWrapper' + i)?.querySelectorAll('.fakeCoverPDF');
                                                            // if(fakeCoverPdfElems) {
                                                            //     for (let index = 0; index <= fakeCoverPdfElems.length; index++) {
                                                            //         const element = fakeCoverPdfElems[index];
                                                            //         lightGallery(element, {
