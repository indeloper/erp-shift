            ...
            <div class="modal-body">
                ...
                <div class="card border-0">
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                    class="col-sm-7"
                                    id="select_upload_tongue_block"
                                    style="display:none"
                            >
                                <select
                                        name="com_offer_id_tongue"
                                        id="select_com_offer_upload_tongue"
                                        style="width:100%"
                                        v-model="com_offer_id_tongue"
                                >
                            ...
                            <div
                                    class="col-sm-7"
                                    id="select_upload_pile_block"
                                    style="display:none"
                            >
                                <select
                                        name="com_offer_id_pile"
                                        id="select_com_offer_upload_pile"
                                        style="width:100%"
                                        v-model="com_offer_id_pile"
                                >
                                    @if(isset($com_offers_options))
                                        <option value="new">Новое коммерческое предложение</option>
                        ...
                        <div
                                class="row"
                                id="com_offer_option"
                                @if(!isset($com_offers_options)) style="display: none;" @endif>
                            <label class="col-sm-5 col-form-label">Наименование<span class="star">*</span></label>
                            <div class="col-sm-7">
                                <input
                                        placeholder="Наименование"
                                        id="com_offer_option_input"
                                        @if(isset($com_offers_options)) required
                                        @endif name="option"
                                        class="form-control"
                                        max="50"
                                        v-model="option"
                                    ...
                                    <label class="form-check-label">
                                        ...
                                        >
                                            ...
                                            <button
                                                    ...
                                                    data-toggle="popover"
                                                    data-placement="top"
                                                    data-content="Стандартный порядок согласования КП"
                                            >
                                    ...
                                    <label class="form-check-label">
                                        ...
                                        >
                                            ...
                                            <button
                                                    ...
                                                    data-toggle="popover"
                                                    data-placement="top"
                                                    data-content="КП перейдёт в статус Согласовано с заказчиком, процесс составления договора не начнётся"
                                            >
                                                <i class="fa fa-info-circle"></i>
                                            </button>
                                        </span>
                ...
                >
                    <div class="col-md-12 text-center">
                        <button
                                type="button"
                                id="submit_form_attach_document"
                                @click="preSubmitCheck"
                                form="attach_document"
                                class="btn btn-info btn-outline"
                                disabled
                        >Сохранить
                        </button> <!-- Кнопка появляется после загрузки или формирования документа -->
                    </div>
                </div>
            </div>
        </div>
