...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="float-left-container">
                        <div class="photo-container">
                            ...
                            @if(Auth::user()->id == $user->id or Auth::user()->can('users_edit'))
                                <a
                                        class="btn btn-sm btn-info btn-outline edit-employee"
                                ...
                                <a
                                        href="#"
                                        class="btn btn-sm btn-outline btn-password"
                                        data-toggle="modal"
                    ...
                    <div class="staff-card">
                        ...
                        <div class="row info-string line-bottom">
                            <label class="col-sm-3 col-form-label label-info-card">Отчетная группа</label>
                            <div class="col-sm-9">
                                <p class="p-info-card"> {{ $user->reportingGroup ? $user->reportingGroup->name : 'Не указан'}} </p>
                            </div>
                        </div>
                        <div class="row info-string line-bottom">
                        ...
                        <div
                                class="row info-string line-bottom"
                        ...
                        @if($user->in_vacation == 1)
                            <div class="row info-string">
                                ...
                                <div class="col-sm-9">
                                    <p class="p-info-card">Пользователь в отпуске с {{ $vacation->from_date }}
                                        по {{ $vacation->by_date }}
                                        Заместитель: {{ $vacation->support_user->full_name }}
                                        @if($vacation->change_authority)
                                            <br>Заместителю на время отпуска передана должность сотрудника, уходящего в
                                            отпуск
                                        @endif
                                    </p>
                                </div>
                        ...
                        @elseif($user->in_vacation == 0 and isset($vacation))
                            <div class="row info-string">
                                <label class="col-sm-3 col-form-label label-info-card">Отпуск</label>
                                <div class="col-sm-9">
                                    <p class="p-info-card">Пользователь будет в отпуске с {{ $vacation->from_date }}
                                        по {{ $vacation->by_date }}.
                                        Заместитель: {{ $vacation->support_user->full_name }}
                                        @if($vacation->change_authority)
                                            <br>Заместителю на время отпуска будет передана должность сотрудника,
                                            уходящего в отпуск
                                        @endif
                                    </p>
                                </div>
                                            ...
                                            @foreach($projects as $project)
                                                <tr>
                                                    <td data-label="Проект">
                                                        <a
                                                                class="table-link"
                                                                href="{{ route('projects::card', $project->id) }}"
                                                        >
                                                            {{ $project->name }}
                                                        </a>
                                                    </td>
                                                    <td data-label="Контрагент">
                                                        <a
                                                                class="table-link"
                                                                href="{{ route('contractors::card', $project->contractor_id) }}"
                                                        >
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    >
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <label class="col-form-label">Старый пароль
                                ...
                                <input
                                        ...
                                        name="old_password"
                                        minlength="7"
                                        onchange="checkOldPassword(this)"
                                        required
                                >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <label class="col-form-label">Новый пароль
                                    <star class="star">*</star>
                                </label>
                                <input
                                        id="password_input"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <label class="col-form-label">Повторите пароль
                                    <star class="star">*</star>
                                </label>
                                <input
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form
                                    id="send_vacation"
                                    action="{{ route('users::to_vacation', $user->id) }}"
                                    method="post"
                            >
                                @csrf
                                <input
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="col-form-label">С даты
                                            <star class="star">*</star>
                                        </label>
                                        <input
                                                id="from"
                                    ...
                                    <div class="col-sm-6">
                                        <label class="col-form-label">По дату
                                            <star class="star">*</star>
                                        </label>
                                        <input
                                                id="by"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        >
                                            ...
                                            <button
                                                    type="button"
                                                    name="button"
                                                    class="btn btn-link btn-primary btn-xs mn-0 pd-0"
                                                    data-container="body"
                                                    data-toggle="popover"
                                                    data-placement="top"
                                                    data-content="Заместителю на время отпуска будет дана должность сотрудника, уходящего в отпуск"
                                            >
                                                <i class="fa fa-info-circle"></i>
                                            </button>
                                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5
                                class="modal-title"
                                id="modal-update"
                        >Изменение должностной категории сотрудника</h5>
                        <button
                                type="button"
                                class="close"
                                data-dismiss="modal"
                                    ...
                                    >
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <validation-provider
                                                        rules="required"
                                                        vid="job-category-select"
                                                        ref="job-category-select"
                                                        v-slot="v"
                                                >
                                                    <el-select
    ...
    @can('user_permissions')
        ...
        >
            <div
                    class="modal-dialog modal-lg permission-modal"
                    role="document"
            >
                <div class="modal-content">
                    <div class="modal-header">
