        ...
        <div class="card ">
                    ...
                    @can('users_delete')
                        <div class="col-md-6">
                            <div class="right-edge">
                                <button class="btn btn-sm btn-danger btn-outline" data-toggle="modal" data-target="#deleteUser">
                                     Удалить сотрудника
                                </button>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="staff-card">
                    <form id="form_create_user" class="form-horizontal" action="{{ route('users::update', $user->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-3 col-form-label">Фамилия<star class="star">*</star></label>
                                <div class="col-sm-7">
                                    <input class="form-control" type="text" name="last_name" value="{{ $user->last_name }}" required maxlength="50" placeholder="Фамилия" {{ Auth::user()->department_id == 5 ? '' : 'readonly' }}>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" type="text" name="first_name" value="{{ $user->first_name }}" required maxlength="50" placeholder="Имя" {{ Auth::user()->department_id == 5 ? '' : 'readonly' }}>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" type="text" name="patronymic" value="{{ $user->patronymic }}" maxlength="50" placeholder="Отчество" {{ Auth::user()->department_id == 5 ? '' : 'readonly' }}>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-7" >
                                    <select id="department" name="department_id" style="width:100%;" required>
                                ...
                                <div class="col-sm-7">
                                    <select id="company" class="js-groups" name="company" style="width:100%;" required>
                                        ...
                                        @foreach($companies as $key => $company)
                                            <option value="{{ $key }}" @if($user->company == $key) selected @endif>{{ $company }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input id="birthday" name="birthday" type="text" value="{{ $birthday }}" class="form-control" placeholder="Выберите дату" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control raz" type="text" value="{{ $user->person_phone }}" id="person_phone" name="person_phone" placeholder="7 (999) 555 32-11" minlength="17" maxlength="17">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control raz" id="work_phone" type="text" value="{{ $user->work_phone }}" name="work_phone" maxlength="5">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="email" id="email" value="{{ $user->email }}" pattern="[a-zA-Z0-9\.-\s]+@[a-zA-Z0-9\-\s]+\.[a-zA-Z0-9]+" name="email" maxlength="50" {{ $user->email ? 'required' : '' }} {{ Auth::user()->can('users_create') ? '' : 'readonly' }}>
                                </div>
                            </div>
                        </div>
                        @if(Auth::id() == 1)
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" value="{{ $user->chat_id }}" name="chat_id" maxlength="50">
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="password" autocomplete="off" pass="pass" id="password" name="password" minlength="7" onchange="checkPassword(this)">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="password" pass="pass" id="password_confirmation" name="password_confirmation" onchange="checkConfirmation(this)" readonly>
                                    <small class="text-muted" style="font-size: 12px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4" style="padding-top: 0">
                                    <select name="status" class="selectpicker" data-style="btn-default btn-outline" data-menu-style="dropdown-blue" required>
                                        ...
                                        <option value="0" @if($user->status == 0) selected @endif>Не активен</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer text-center">
                    <button id="update_user_submit" type="submit" form="form_create_user" class="btn btn-info btn-outline">Сохранить</button>
                </div>
            </div>
        </div>
    </div>
...
@can('users_delete')
    <div class="modal fade modal-primary" id="deleteUser" role="dialog" aria-labelledby="modal-search" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    <form id="remove_user" action="{{ route('users::remove', $user->id) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <label class="col-form-label">Заместитель<star class="star">*</star></label>
                                <select id="js-select-user" name="support_user_id" style="width: 100%" required onchange="checkValue(this)"></select>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button id="remove_submit" class="btn btn-sm btn-info btn-outline" disabled="disabled" onclick="deleteUser()">Сохранить</button>
                </div>
            </div>
        </div>
    </div>
