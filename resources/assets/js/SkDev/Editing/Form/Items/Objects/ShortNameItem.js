                  ...
                  toolbarItems: [
                    {
                      ...
                      onClick(e) {
                        ...
                        console.log(shortNameFormInstance.option('formData'));
                        dataGridInstance.updateData('short_name', shortName);
                        dataGridInstance.updateData('short_name_detail', JSON.stringify(shortNameFormInstance.option('formData')));
                        // dataGridInstance.repaint();
                        // console.log(dataGridInstance);
                        console.log(shortName);
                        console.log(dataGridInstance.option('formData'));
                        console.log(123);
                        //dataGridInstance.option('formData', { short_name: shortName });
